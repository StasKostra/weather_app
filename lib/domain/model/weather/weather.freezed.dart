...
class _$WeatherParamsImpl implements _WeatherParams {
  ...
  @override
  String toString() {
    return 'WeatherParams(temp: $temp, tempMin: $tempMin, tempMax: $tempMax, humidity: $humidity)';
  }
...
abstract class _WeatherParams implements WeatherParams {
  factory _WeatherParams(
      ...
      required final double humidity}) = _$WeatherParamsImpl;
...
class _$WeatherImpl implements _Weather {
  ...
  @override
  String toString() {
    return 'Weather(weatherParams: $weatherParams, weatherInfo: $weatherInfo, cityName: $cityName, icon: $icon, dt: $dt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, weatherParams,
      const DeepCollectionEquality().hash(_weatherInfo), cityName, icon, dt);
